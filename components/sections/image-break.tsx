    ...
    <section className="relative h-96 lg:h-[60vh] group" ref={ref}>
      <div className="relative w-full h-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div
            className={`text-center text-white transition-all duration-1000 border border-white/30 p-8 ${
          ...
          >
            ...
            <Button
              asChild
              className="group relative bg-white hover:bg-gray-100 text-black px-8 py-3 rounded-none text-lg transition-colors overflow-hidden"
            >
              <Link href="/contact">
