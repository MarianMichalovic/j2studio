    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-24" ref={storyRef}>
        <div className="grid lg:grid-cols-2">
          <div
            className={`px-6 lg:px-20 flex flex-col justify-center transition-all duration-1000 ${
              storyInView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"
            }`}
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-neutral-900 mb-8">Náš príbeh</h2>
      ...
      <section className="px-6 py-24 bg-neutral-50" ref={valuesRef}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2
              className={`text-4xl lg:text-5xl font-bold text-neutral-900 mb-4 transition-all duration-1000 ${
